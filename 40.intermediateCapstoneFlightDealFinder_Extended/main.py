...
from mail_manager import Manage_Mail
...
answer=("Do you want to enter your Email:y/n")
if answer == "y":
    manage_mail.add_user_email()
...
for destination in sheet_data:
    ...
    if flight is not None and flight.price < destination["lowestPrice"]:
        for mail in data_manager.get_destination_data():
            manage_mail.send_email(mail[0], mail[1], mail[2])
